//signup logic all business logic will be written here
...
export async function login(req , res) {
   try {
    ...
    //first parameter hoga joh token tumne create kiya and second parameter joh hum pass krenge voh hoga secret key but it should also be hidden so hum usko .env me rkhenge and here {expiresIn: "1d"} it means ki 1 din me token expire hojayega 
